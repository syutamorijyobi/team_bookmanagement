...
public class MailUtil {
	// 送信元のユーザの情報等を定数で設定する。
	private static final String FROM = "y.sekimura.sys22@morijyobi.ac.jp";
	private static final String NAME = "sekimura";
	private static final String PW = "lkyfniezmlgpqmpz";
