...
/**
 * Servlet implementation class AuthorListServlet
 */
@WebServlet("/RootAuthorListServlet")
public class RootAuthorListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RootAuthorListServlet() {
        super();
