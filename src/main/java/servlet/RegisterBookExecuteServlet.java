...
public class RegisterBookExecuteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RegisterBookExecuteServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(result == 1) {
			...
			path = "WEB-INF/view/register_book_success.jsp";
		} else {
			path = "WEB-INF/view/register_book_form.jsp?error=1";
		}
