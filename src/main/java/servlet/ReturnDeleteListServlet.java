...
/**
 * Servlet implementation class ReturnDeleteListServlet
 */
@WebServlet("/ReturnDeleteListServlet")
public class ReturnDeleteListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReturnDeleteListServlet() {
        super();
