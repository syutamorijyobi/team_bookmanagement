...
/**
 * Servlet implementation class RegisterIsbnFormServlet
 */
@WebServlet("/RegisterIsbnFormServlet")
public class RegisterIsbnFormServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RegisterIsbnFormServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String view = "WEB-INF/view/register_isbn_form.jsp";
